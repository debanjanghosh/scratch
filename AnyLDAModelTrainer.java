...
public class AnyLDAModelTrainer {
	...
	public AnyLDAModelTrainer(TokenizerFactory tokenizerFactory,
	...
	public void trainModel() throws IOException {
		...
		short numTopics = 5;
		double topicPrior = 0.2; //1/100 //1/5
		...
		CharSequence[] articleTexts = LDADataUtil.readCrimeLdaInput(inputDirectory);
		...
		int maxTopicsPerDoc = 5;//5 topics per tweet
	...
	public static void main(String[] args) throws Exception 
	{
		...
		AnyLDAModelTrainer ldaModelTrainer = new AnyLDAModelTrainer(tokenizerFactory,
	...
	private static TokenizerFactory createTokenizer() throws Exception {
		...
		//here we train any type of data and model and based on that we can 
		//filter almost any type of factory
...
//		DictionaryReaderFactoryBean dictBean = new DictionaryReaderFactoryBean(headwordFiles,conflationsFiles) ;
   ...
   //     KrovetzStemmer stemmer = new KrovetzStemmer();
	...
	private static Set<String> loadStopWords() throws IOException {
		...
		String stopFile = "./config/lda/crimestop.lst" ;
