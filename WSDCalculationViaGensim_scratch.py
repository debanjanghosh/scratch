...
def main():
  ...
  #  loadWordVector()
    ...
    unigramPaths.append(scratchPath+'/data/input/random_tokens/')
    
    simScorePaths = []
    simScorePaths.append(scratchPath+'/data/output/WSDFolder/sarcasm_testing_wsd_scores_cbow_gensim_align/')
    simScorePaths.append(scratchPath+'/data/output/WSDFolder/random_testing_wsd_scores_cbow_gensim_align/')
