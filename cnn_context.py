...
def train_conv_net(train_data,
    ...
    while (epoch < n_epochs):
        ...
        logger.error('epoch %i, last training batch %f, val perf %f %%' % (epoch, cost_epoch, val_perf*100.))
...
def test(target):
    ...
    train_file = './data/output/context/pkl/1_cnn/' + 'tweet.' + target + '.target.TRAIN' + '.pkl'
    model_file = './data/models/context/pkl/1_cnn/' + 'tweet.' + target + '.target.TRAIN' + '.model.pkl'
    
    test_file = './data/output/context/pkl/1_cnn/' + 'tweet.' + target + '.target.TEST' + '.pkl'
    output_file = './data/output/context/pred/1_cnn/' + target + '.pred'
...
def test_senti(target):
    ...
    train_file = './data/output/samelm/pkl/senti/1_cnn/' + 'tweet.' + target + '.target.SENTI.BOTH.TRAIN' + '.pkl'
    model_file = './data/models/samelm/senti/1_cnn/' + 'tweet.' + target + '.target.TRAIN' + '.model.pkl'
    
    test_file = './data/output/samelm/pkl/senti/1_cnn/' + 'tweet.' + target + '.target.SENTI.BOTH.TEST' + '.pkl'
    output_file = './data/output/samelm/pred/senti/1_cnn/' + target + '.pred'
...
def train(target):
    ...
    perf = train_conv_net(idx_train_data,
                          ...
                          batch_size=batch_size,
                          dropout_rate=0.5)
    print "test perf: " + target + ' :' + str(perf)
...
def listTargets():
    file = open('./data/config/targets_small.txt')
